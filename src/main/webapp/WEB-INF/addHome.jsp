...
<nav class="navbar navbar-expand-lg bg-body-tertiary bg-info text-white">
  <div class="container-fluid">
	...
	<h1 class="mt-4 ms-2">Add your Dream Home</h1>
<div class="container-sm text-bg-dark border border-info border border-5 rounded-3 mx-auto my-5 pt-2 pb-5">
	<form:form action="/homes/new" method="post" modelAttribute="house">

		<!-- establishes the relationship, reader is the variable from the Book model that creates the join id -->
		<!-- Do not pass in the value as the User model, not safe. Only the User id.  -->
		<form:input type="hidden" path="dreamHomeCreator" value="${userId }"></form:input>
		...
		<div class="form-group mb-3">
			<!-- path has to match up with model variable -->
			<form:label path="imageURL">Link to Dream Home:</form:label>
